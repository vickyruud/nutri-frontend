...
function CommentList({ comments }) {
  ...
  return (
    <div className='flex flex-col items-center gap-4 w-3/6'>
      ...
      <div className='flex flex-col bg-white w-full h-full  pl-5 pr-5 rounded-lg border border-gray-200 shadow-xl dark:bg-gray-800 dark:border-gray-700 mb-5'>{arrayOfComments.reverse()}</div>
    </div>
  )
}
